...
const extraData = [
  {
    lastUpdated: dayjs().subtract(1, 'day'),
    projectName: 'Project 1',
    projectDescription: '',
    lastUpdatedBy: 'Tiong',
  },
  {
    lastUpdated: dayjs().subtract(1, 'week'),
    projectName: 'Project 2',
    projectDescription: '',
    lastUpdatedBy: 'Elodie',
  },
  {
    lastUpdated: dayjs().subtract(3, 'months'),
    projectName: 'Project 3',
    projectDescription: '',
    lastUpdatedBy: 'Gabriel',
  },
];
...
export default function HomePage() {
  ...
  const { data: groupedProjects } = useQuery({
    ...
    queryFn: async () => {
      ...
      return groupProjectsIntoTimeBins([...projectsMapped, ...extraData]);
    },
    enabled: !!session,
  });
